...
DEST_DIRECTORY="./videos"

printf -e "Voot Media ID : $MEDIA_ID\n\n"

responseContent=$(curl -X GET "Accept: application/json" "https://wapi.voot.com/ws/ott/getMediaInfo.json?platform=Web&pId=2&mediaId=$MEDIA_ID")
